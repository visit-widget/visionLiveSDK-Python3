...
class ApiClient(object):
    ...
    def _sign(self, params):
        ...
        keys = self._sortedIgnoreCase(list(params.keys()))
    ...
    def execute(self, method_name, **kwargs):
        ...
        urlopen = urllib.request.urlopen(self.serverUrl, urllib.parse.urlencode(params).encode("utf-8"))
        rsp = urlopen.read()
